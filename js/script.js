...
function filterWorkshops() {
    ...
    noSelection = (selectedGradeRanges.length == 0 && selectedSubjects.length == 0 && selectedClassTimes.length == 0 && selectedOrigins.length == 0)
    workshopBlocks.forEach((block) => {
        ...
        const show = noSelection ||
            ...
            selectedOrigins.some((origin) => block.classList.contains(origin));
